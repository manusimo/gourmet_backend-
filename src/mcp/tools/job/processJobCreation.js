...
class ProcessJobCreationTool extends BaseTool {
  ...
  extractPositionFromMessage(message) {
    const positions = {
      ...
      'maestro pastelero': 'Maestro Pastelero',
      'pastelero': 'Pastelero',
      'panadero': 'Panadero',
      'repostero': 'Repostero',
      ...
      'itamae': 'Itamae',
      'sushiman': 'Sushiman',
      'ayudante de sushi': 'Ayudante de Sushi',
      'parrillero': 'Parrillero',
      'cocinero frío': 'Cocinero Frío',
      'cocinero frio': 'Cocinero Frío',
      ...
      'encargado de produccion': 'Encargado de Producción',
      'operador de cocina': 'Operador de Cocina',
      ...
      'recepcionista de restaurante': 'Recepcionista de Restaurante',
      'recepcionista': 'Recepcionista de Restaurante',
      'supervisor de salon': 'Supervisor de Salón',
      'supervisor de salón': 'Supervisor de Salón',
      'personal de banquetería': 'Personal de Banquetería',
      'personal de banqueteria': 'Personal de Banquetería',
      'encargado de bodega': 'Encargado de Bodega',
      'repositor': 'Repositor',
      'personal de mantenimiento': 'Personal de Mantenimiento',
      'jefe de local': 'Jefe de Local',
      'administrador de local': 'Administrador de Local',
      'jefe de sucursales': 'Jefe de Sucursales',
      'administrador de restaurante': 'Administrador de Restaurante',
      'encargado de compras': 'Encargado de Compras',
      'control de calidad': 'Control de Calidad',
      'catador de vinos': 'Catador de Vinos',
      'coordinador de banquetes': 'Coordinador de Banquetes',
