  ...
  constructor() {
    this.fieldDefinitions = {
      position: {
        ...
        suggestion: 'Especifica la posición: Garzón, Runner, Chef, Ayudante de Cocina, Anfitrión, Delivery, Cajero, Copero, Barista, Bartender, Sommelier, Maitre, Jefe de salón, o Limpieza'
      },
      schedule: {
