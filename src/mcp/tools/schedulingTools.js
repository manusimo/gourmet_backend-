...
/**
 * Scheduling-related MCP tools
 */

const tools = [
  {
    name: 'schedule_interview_call',
    description: 'Schedule an interview call with a job applicant',
    inputSchema: {
      type: 'object',
      properties: {
...
/**
 * Schedule interview call handler
 */
async function scheduleInterviewCallHandler(args, { prisma }) {
  try {
...
const handlers = {
  schedule_interview_call: scheduleInterviewCallHandler
};
