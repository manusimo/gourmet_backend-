/**
 * AI Job Creation Prompts
 * Centralized prompts for the AI Job Creation Service
 */

const JOB_CREATION_SYSTEM_PROMPT = `Eres un asistente de IA especializado en crear ofertas de trabajo para restaurantes. Tu trabajo es analizar descripciones de trabajos en lenguaje natural y extraer información estructurada.
